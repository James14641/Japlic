...
Table.insert(0,"nx",nx);Table.insert(4,"Tmin",Tmin);Table.insert(5,"Tmax",Tmax);
...
plt.ylabel(r'$\log(err)$');plt.legend();
plt.suptitle("FEBEDC_relative_space_convergence_4_it")


plt.savefig('FEBEDC_Space_convergence_4it.png')
